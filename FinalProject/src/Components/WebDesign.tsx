...
const WebDesign = () => {
    ...
    useEffect(() => {
        async function WebDesign() {
            try {
                const response = await axios.get(`https://7d501367-4615-4a19-9b28-489c83cb8582-00-uzzhfldkfse1.sisko.replit.dev/categories/Web%20Design/courses`);
            ...
            <div>
                <div className="mx-auto max-w-7xl mb-12">
                    <header className="mb-12 text-center md:text-left">
                        <h1 className="text-4xl font-extrabold text-slate-900 dark:text-white">Web Design</h1>
                    </header>
